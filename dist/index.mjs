...
function Be(e) {
  ...
  }, [e.disableCSSOMInjection, e.sheet, e.target, t]), o2 = r.useMemo(function() {
    return xe({ options: { namespace: e.namespace, prefix: e.enableVendorPrefixes }, plugins: e.stylisPlugins });
  }, [e.enableVendorPrefixes, e.namespace, e.stylisPlugins]), s = r.useMemo(function() {
    return { shouldForwardProp: e.shouldForwardProp, styleSheet: n, stylis: o2 };
  }, [e.shouldForwardProp, n, o2]);
  return r.createElement(Ve.Provider, { value: s }, r.createElement(Ge.Provider, { value: o2 }, e.children));
}
var Le = (function() {
  function e(e2, t) {
    var n = this;
...
function createSlot(ownerName) {
  ...
  const Slot2 = React6.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx2(SlotClone, __spreadProps(__spreadValues({}, slotProps), { ref: forwardedRef, children: React6.isValidElement(newElement) ? React6.cloneElement(newElement, void 0, newChildren) : null }));
    }
...
var Primitive = NODES.reduce((primitive, node2) => {
  ...
  const Node2 = React7.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx3(Comp, __spreadProps(__spreadValues({}, primitiveProps), { ref: forwardedRef }));
  });
...
var DismissableLayerBranch = React10.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx4(Primitive.div, __spreadProps(__spreadValues({}, props), { ref: composedRefs }));
});
...
var FocusScope = React11.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx5(Primitive.div, __spreadProps(__spreadValues({ tabIndex: -1 }, scopeProps), { ref: composedRefs, onKeyDown: handleKeyDown }));
});
...
var Portal = React12.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM2.createPortal(/* @__PURE__ */ jsx6(Primitive.div, __spreadProps(__spreadValues({}, portalProps), { ref: forwardedRef })), container) : null;
});
...
// src/node_modules/.pnpm/@radix-ui+react-dialog@1.1.15_@types+react-dom@19.2.3_@types+react@19.2.14__@types+reac_779045218dc2799d336e7197abef9d38/node_modules/@radix-ui/react-dialog/dist/index.mjs
import { Fragment as Fragment5, jsx as jsx7, jsxs } from "react/jsx-runtime";
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx7(PortalProvider, { scope: __scopeDialog, forceMount, children: React24.Children.map(children, (child) => /* @__PURE__ */ jsx7(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx7(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? /* @__PURE__ */ jsx7(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx7(DialogOverlayImpl, __spreadProps(__spreadValues({}, overlayProps), { ref: forwardedRef })) }) : null;
  }
);
...
var DialogOverlayImpl = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      /* @__PURE__ */ jsx7(Combination_default, { as: Slot, allowPinchZoom: true, shards: [context.contentRef], children: /* @__PURE__ */ jsx7(
        Primitive.div,
        __spreadProps(__spreadValues({
          "data-state": getState(context.open)
        }, overlayProps), {
...
var DialogContent = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx7(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ jsx7(DialogContentModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) : /* @__PURE__ */ jsx7(DialogContentNonModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) });
  }
);
...
var DialogTitle = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx7(Primitive.h2, __spreadProps(__spreadValues({ id: context.titleId }, titleProps), { ref: forwardedRef }));
  }
);
...
var DialogDescription = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx7(Primitive.p, __spreadProps(__spreadValues({ id: context.descriptionId }, descriptionProps), { ref: forwardedRef }));
  }
);
...
import { jsx as jsx10, Fragment as Fragment6 } from "react/jsx-runtime";
import { useMemo as useMemo6, useRef as useRef12, useState as useState10, useContext as useContext5 } from "react";
...
var PresenceContext = /* @__PURE__ */ createContext5(null);
...
import { useId as useId2, useRef as useRef11, useContext as useContext3, useInsertionEffect as useInsertionEffect2 } from "react";
...
var MotionConfigContext = createContext6({
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  return jsx8(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, pop, children: pop === false ? children : React26.cloneElement(children, { ref: composedRef }) });
}
...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  children = jsx9(PopChild, { pop: mode === "popLayout", isPresent, anchorX, anchorY, root, children });
  return jsx9(PresenceContext.Provider, { value: context, children });
};
...
import { useContext as useContext4, useId as useId4, useEffect as useEffect16, useCallback as useCallback8 } from "react";
function usePresence2(subscribe = true) {
  const context = useContext4(PresenceContext);
  if (context === null)
    return [true, null];
  ...
  const safeToRemove = useCallback8(() => subscribe && onExitComplete && onExitComplete(id3), [id3, onExitComplete, subscribe]);
...
import { Children as Children5, isValidElement as isValidElement2 } from "react";
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  const isInitialRender = useRef12(true);
  const pendingPresentChildren = useRef12(presentChildren);
  const exitComplete = useConstant(() => /* @__PURE__ */ new Map());
  const exitingComponents = useRef12(/* @__PURE__ */ new Set());
  const [diffedChildren, setDiffedChildren] = useState10(presentChildren);
  const [renderedChildren, setRenderedChildren] = useState10(presentChildren);
  ...
  const { forceRender } = useContext5(LayoutGroupContext);
  return jsx10(Fragment6, { children: renderedChildren.map((child) => {
    const key = getChildKey(child);
    ...
    return jsx10(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, anchorY, children: child }, key);
  }) });
};
...
var LazyContext = createContext7({ strict: false });
...
import { forwardRef as forwardRef9, useContext as useContext9 } from "react";
...
var MotionContext = /* @__PURE__ */ createContext8({});
...
import { Fragment as Fragment7, useMemo as useMemo10, createElement as createElement6 } from "react";
...
function useRender(Component3, props, ref, { latestValues }, isStatic, forwardMotionProps = false, isSVG) {
  ...
  const elementProps = Component3 !== Fragment7 ? __spreadProps(__spreadValues(__spreadValues({}, filteredProps), visualProps), { ref }) : {};
  const { children } = props;
  const renderedChildren = useMemo10(() => isMotionValue(children) ? children.get() : children, [children]);
  return createElement6(Component3, __spreadProps(__spreadValues({}, elementProps), {
...
import { useRef as useRef13, useInsertionEffect as useInsertionEffect3, useCallback as useCallback9 } from "react";
function useMotionRef(visualState, visualElement, externalRef) {
  const externalRefContainer = useRef13(externalRef);
  useInsertionEffect3(() => {
    externalRefContainer.current = externalRef;
  });
  const refCleanup = useRef13(null);
  return useCallback9((instance) => {
    var _a2;
    if (instance) {
...
import { useContext as useContext8, useRef as useRef14, useInsertionEffect as useInsertionEffect4, useEffect as useEffect17 } from "react";
...
var SwitchLayoutGroupContext = createContext9({});
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  ...
  const visualElementRef = useRef14(null);
  const hasMountedOnce = useRef14(false);
  ...
  const isMounted = useRef14(false);
  useInsertionEffect4(() => {
  ...
  const wantsHandoff = useRef14(Boolean(optimisedAppearId) && typeof window !== "undefined" && !((_a2 = window.MotionHandoffIsComplete) == null ? void 0 : _a2.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect2(() => {
...
function createMotionComponent(Component3, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    return jsxs2(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? jsx11(MeasureLayout2, __spreadValues({ visualElement: context.visualElement }, configAndProps)) : null, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps, isSVG)] });
  }
  ...
  const ForwardRefMotionComponent = forwardRef9(MotionDOMComponent);
...
var createDomVisualElement = (Component3, options) => {
  ...
  return isSVG ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== Fragment8
  });
};
...
function MeasureLayout(props) {
  ...
  return jsx12(MeasureLayoutWithContext, __spreadProps(__spreadValues({}, props), { layoutGroup, switchLayoutGroup: useContext10(SwitchLayoutGroupContext), isPresent, safeToRemove }));
}
...
// src/BaseModal.tsx
import { useState as useState12, useEffect as useEffect19, useCallback as useCallback10 } from "react";
function useMeasure() {
  const [node2, setNode] = useState12(null);
...
function ButterModal(props) {
  return /* @__PURE__ */ React29.createElement(BaseModal_default, __spreadValues({}, props));
}
export {
  ButterModal
};
